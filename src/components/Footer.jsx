      ...
      <div className="container-x flex flex-col gap-8 py-12">
        <div className="flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-center">
          <a href="#home" className="font-display text-xl font-extrabold">
            Awad<span className="text-accent">.</span>
          </a>
        ...
        <div className="border-t border-white/10 pt-6 text-center text-sm text-white/60 sm:text-left">
          © {currentYear} Awad Mohammed. All rights reserved.
        </div>
      </div>
    </footer>
  );
